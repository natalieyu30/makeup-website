...
export default function SecondBanner() {
  return (
    <div className="flex flex-col sm:flex-row container mx-auto bg-pink items-center justify-between gap-0 sm:gap-10 my-10 relative -bottom-40">
      <div className="p-8">
